...
public class TmdbImageUrl {
    ...
    public enum BackdropWidth {w300,w780,w1280,original}
    public enum ProfileWidth {w45,w185,h632,original}
    ...
    public static String generateProfileUrl(String path, ProfileWidth width) {
        String url = imageBaseUrl;
